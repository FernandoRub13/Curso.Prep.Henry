...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  const isLargeNumber = (element) => element === elemento;
  return (array.findIndex(isLargeNumber) === -1) ? false : true;
}
